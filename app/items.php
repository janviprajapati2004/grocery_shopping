        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse"
                   ...
                   <!-- <a href="#" class="logo"> <i class="fa-light fa-cart-shopping"></i>GROCERY MART </a> -->
                    ...
                    <div class="widget widget-cart">
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                // Check if the cart_item session is set and is an array
                                if (isset ($_SESSION["cart_item"]) && is_array($_SESSION["cart_item"])) {
                                    foreach ($_SESSION["cart_item"] as $item) {
                                        ...
                                        <div class="title-row">
                                            ...
                                            <a
                                                href="items.php?id=<?php echo urlencode($_GET['res_id']); ?>&action=remove&id=<?php echo urlencode($item["d_id"]); ?>">
                                        ...
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                <input type="text" class="form-control b-r-0"
                                                    value="<?php echo "₹" . htmlspecialchars($item["price"]); ?>" readonly
                                                    id="exampleSelect1">
                                            </div>
                                            <div class="col-xs-4">
                                        ...
                                        <div class="row">
                                                ...
                                                <form method="post"
                                                    ...
                                                    <div class="rest-logo pull-left">
                                                        ...
                                                        <a class="restaurant-logo pull-left"
                                                            href="#">
                                                            <img src="admin/Res_img/items/<?php echo htmlspecialchars($product['img']); ?>" alt="Product Image">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info">
                                                ...
                                                <input class="b-r-0" type="text" name="quantity" style="margin-left:30px;"
                                                    value="1" size="2" />
                                                <input type="submit" class="btn theme-btn" style="margin-left:60px;"
                                                    value="Add to cart" />
                                            </div>
                                            </form>
                                        </div>
